...
$Log: ethdev.fun,v $
Revision 1.30  1996/12/20  21:41:36  esb
added truncation of incoming messages to actual size.

Revision 1.29  1996/07/22  17:43:30  cline
*** empty log message ***

Revision 1.28  1996/04/18  21:27:51  cline
alpha_osf1/
   ...
   fun receive_timeout (fd, self, handler, packets_received,
	 ...
	 if Packet_Filter.select (fd, ms) then
	  ...
	  in log_packet (Word_Array.to8 buffer, "received");
	     ...
	     (((! handler) (External.new (Buffers.truncate (buffer,
							    bytes_read))))
